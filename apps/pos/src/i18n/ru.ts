...
export const ru = {
  ...
  'shift.close.doesNotAddUp': 'Строки выше не складываются в эту сумму. Пересчитайте наличные как есть и скажите владельцу — закрыть смену это не мешает.',
  ...
  'return.toSplit': 'Чек оплачен несколькими способами — возврат пройдёт теми же, каждым в свою долю. Наличную часть отдайте из кассы, остальное отмените там, откуда пришло.',
