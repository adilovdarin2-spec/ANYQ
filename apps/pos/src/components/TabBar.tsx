...
export type MainTab = 'floor' | 'sale' | 'products' | 'operations' | 'profile';
...
export function TabBar({ active, onChange, showProducts, showOperations, showFloor, operationsBadge = 0 }: Props) {
