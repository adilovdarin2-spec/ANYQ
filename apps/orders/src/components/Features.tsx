...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Приход, списание и перемещение сразу меняют остаток на сервере, и каждая касса подтягивает его сама — при открытии, при возврате связи и раз в минуту.',
  },
  {
    icon: IconSmartphone,
  ...
  },
  {
    ...
    desc: 'Зона, стеллаж, ячейка. Товар ищут по адресу, а не по памяти кладовщика — и пересчёт идёт по ячейкам, не по всему складу сразу.',
  },
  {
    icon: IconChart,
    title: 'Рецепты и себестоимость',
    desc: 'Выпечка, фасовка и наборы: ингредиенты списываются по рецепту, а отчёт показывает себестоимость и маржу готовой позиции.',
  },
  {
    icon: IconPill,
      ...
      <div className="section-inner">
        <div className="section-head">
          ...
          <p className="section-sub">
            ...
            небольшие сети, аптеки и оптовых поставщиков.
          </p>
        </div>
