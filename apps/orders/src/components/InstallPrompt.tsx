  ...
  return (
    <div className="install-banner" role="dialog" aria-label="Установка приложения">
      <div className="install-banner-head">
        <span className="install-banner-title">Поставьте магазин на экран</span>
        <button className="icon-btn" onClick={dismiss} aria-label="Закрыть">✕</button>
      </div>

      {platform === 'ios' ? (
        <>
          <p>Откроется как обычное приложение, без Safari сверху — быстрее заходить за новым заказом.</p>
        ...
        <>
          <p>Открывается как обычное приложение — без магазина приложений.</p>
